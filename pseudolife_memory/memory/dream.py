...
# v12 (2026-09-07, after PR #279's gates): the two worked examples that
# had been paraphrased from LongMemEval turns (a4686df6, 2026-08-01)
# are re-cut on invented tokens, and the count rule gains a second
# inline example for counts OF items from a source; every rule
# sentence is otherwise byte-identical to v10. v12 alone vs v10 alone
# (reproducible Qwen3.8, one window; prompt-recut-v12-ku-paired-
# verdict.json): rag control 0 flips, cortex 0.667 -> 0.718 (7W/3L,
# p 0.34), hybrid unchanged, cascade 0.859 -> 0.910 (4W/0L, p 0.125),
# all seven frozen-total questions cortex-correct; paired ladder
# verdict-identical (ladder-v12recut-paired-verdict.json); live e4b-v3
